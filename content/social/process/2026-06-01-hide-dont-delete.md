---
title: "Hide, don't delete. Audit as you go."
...
# Hide, don't delete. Audit as you go.

> Schedule: **Mon 2026-06-01** · Pillar: process · Stance: builder · Status: draft
...
- **Case-study tie**: process-pillar nugget. Doesn't slot directly into Afi or KT360 — belongs in a "how I refactor" write-up on the process feed.
- **LinkedIn graphic concept**: mock of the component sidebar split in two. **Active**: Logo. **Hidden** (greyed out, with a small "eye-off" icon): Button, Input, Select, Checkbox, Switch, Tabs. A "show hidden" toggle above. Caption: *"The audit reveals itself when you reach for the next screen."* Optional movement: one hidden item slides back to active when the cursor approaches a screen that needs it.
- **CTA link target**: process write-up (TBD — write one before this date).
