---
title: "AI is fast. The system makes it compound."
...
# AI is fast. The system makes it compound.

> Schedule: **Fri 2026-05-22** · Pillar: process · Stance: builder · Status: draft
...
- **Case-study tie**: Afi → Unified Design Platform + Token Architecture. KT360 → Rules as Files. Both case studies are about exactly this trade-off.
- **LinkedIn graphic concept**: two-line velocity chart. Line A ("Solo + AI") steep climb then flatlines around screen 10–15 with annotations *"reconciling tokens"*, *"renaming components"*, *"rewriting demos"*. Line B ("System + AI") slower opening, no flatline, keeps climbing past screen 30. X-axis: screens shipped. Y-axis: consistent surfaces. Hand-drawn feel, vibe-graphic not Tufte.
- **CTA link target**: `https://richgriner.com/work` (links to both case studies via the work index)
