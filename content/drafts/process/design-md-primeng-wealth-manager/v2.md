---
title: "Writing a design.md for a PrimeNG product"
pillar: process
status: draft
created: 2026-04-23
...
# Writing a design.md for a PrimeNG product
...
*Built alongside Claude (Anthropic). Wealth Manager is one surface in AFI's broader design-system initiative; the internal DS itself, Coherence, is a separate code-first shadcn-based library with its own case study.*
