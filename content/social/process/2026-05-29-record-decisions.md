---
title: "Record yourself making decisions"
...
# Record yourself making decisions

> Schedule: **Fri 2026-05-29** · Pillar: process · Stance: builder · Status: draft
...
- **Case-study tie**: the practice underneath every case study. Doesn't slot into a specific bento card — it's the meta-process that makes the case-study writeups possible at all.
- **LinkedIn graphic concept**: vertical "decision stack" — three or four thought bubbles in a column, each linked to a small artifact below it: *"Why this animation curve?"* → tiny easing-token code block; *"Why this token name?"* → Figma variable panel snippet; *"Why hide instead of delete?"* → sidebar mock; *"Why segmented control over tabs here?"* → tab-vs-segmented comparison. Caption: *"Micro-decisions are where the craft is. Most of them leak out of memory by Friday."*
- **CTA link target**: long-form process write-up (TBD — could be a new piece, or link the portfolio's process feed once a few of these are live).
